                                ...
                                {_.get(this.props, 'pageContext.site.data.footer.about.actions') && 
                                    <ul className="actions">
                                        {_.map(_.get(this.props, 'pageContext.site.data.footer.about.actions'), (action, action_idx) => (
                                            <li key={action_idx}><Link to={(_.get(action, 'url').startsWith('#') ? _.get(action, 'url') : safePrefix(_.get(action, 'url')))} className={'icon ' + _.get(method, 'icon')}>{_.get(action, 'label')}</Link></li>
                                        ))}
                                    </ul>
                                }
                            </section>
